...
${errorInfo.componentStack}`);
  ...
  var Checkout_default = reactExtension(
    ...
    () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ExtensionItems, {})
  );
  function ExtensionItems() {
    var _a;
    const applyCartLinesChange = useApplyCartLinesChange();
    const onClickAddToCart = (id) => __async(this, null, function* () {
      let result = yield applyCartLinesChange({
        type: "addCartLine",
        merchandiseId: id,
        quantity: 1
      });
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      Grid2,
      {
        ...
        spacing: "tight",
        children: (_a = data == null ? void 0 : data.products) == null ? void 0 : _a.nodes.map((node) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(GridItem, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(HeadingGroup2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { children: node.title }) }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { onPress: () => onClickAddToCart(node.variants.nodes[0].id), children: "Add to Cart" })
        ] }))
      }
    );
  }
